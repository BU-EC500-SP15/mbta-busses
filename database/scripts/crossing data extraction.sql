...
AS (
	...
	and r.ROUTE_NAME in ('01','15','22','23','28','32','39','57','66','71','73','77','111','116','117')
...
SELECT UNIQUE_ID
	...
	,CAST(SCHEDULED_TIME AS INT)/60 ScheduledTimeInMin
	,CAST(ACT_ARRIVAL_TIME AS INT)/60 ActArrivalTimeInMin
	,CAST(ACT_DEPARTURE_TIME AS INT)/60 ActDepartureTimeInMin
